...
PA.tabs = [
  ...
  { key: "designer", label: "Designer", role: "Voor designers",
    order: ["contrastpicker", "grayscale", "forcefocus", "targetsize", "textspacing", "textresize", "imagesoff", "ruler"] },
  { key: "developer", label: "Developer", role: "Voor ontwikkelaars",
    order: ["aria", "accname", "formerrors", "tabindex", "forcefocus", "contrastpicker", "textspacing", "textresize", "iframes", "elementinfo"] },
];
PA.activeTab = 0;
PA.start();
