...
PA.tabs = [
  ...
  { key: "designer", label: "Designer", role: "Voor designers",
    order: ["contrastpicker", "grayscale", "forcefocus", "targetsize", "textspacing", "textresize", "textresize400", "outline", "landmarks", "imagesoff", "ruler"] },
  { key: "developer", label: "Developer", role: "Voor ontwikkelaars",
    order: ["aria", "accname", "tabindex", "forcefocus", "contrastpicker", "textspacing", "textresize", "landmarks", "iframes", "elementinfo"] },
];
PA.activeTab = 0;
PA.start();
