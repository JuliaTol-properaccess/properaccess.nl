...
keywords:
  ...
  - EAA Netherlands
  - EAA compliance Netherlands
  - EN 301 549
  - WCAG 2.1 AA EAA
  - EAA regulator Netherlands
  - EAA microenterprise
  - accessibility law Netherlands companies
...
banner:
  ...
  button:
    enable: true
    label: "Ask us where you stand"
    link: "/en/contact/"

trust:
  label: "Audited for, among others"
  names:
    - "De Bijenkorf"
    - "Plus"
    - "Jumbo"
...
sections:
  ...
  - eyebrow: "Two exceptions"
    title: "Disproportionate burden is a file, not an opt-out"
    ...
    card_eyebrow: "Timing"
    card_icon: "schedule"
    card_title: "The dates that matter"
    card_list:
...
steps_header: "What to do first"
steps:
  - title: "Find out where you stand"
    body: "A manual audit following WCAG-EM shows which problems your service has and how severe they are. A [mini audit](/en/mini-audit/) of €495 gives you the biggest issues within five working days; a [full audit](/en/accessibility-audit/) gives you every finding per component."
  - title: "Fix, and report where required"
    body: "The ACM and the AFM require you to fix problems at once or to report them, with a deadline of one week for critical and serious problems and one month for moderate and minor ones. Our report gives you the wording: which function, which WCAG criterion, which platform, what you are doing about it."
  - title: "Prove it and publish it"
    body: "A retest records per finding that the problem is gone; that is what a regulator wants to see. Then publish information about the accessibility of your service on its own page on your website, so a visitor can find it without reading your terms and conditions."
