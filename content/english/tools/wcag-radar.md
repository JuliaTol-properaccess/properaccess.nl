...
tabs:
  ...
  - label: "Designer"
    checks:
      ...
      - titel: "Resize text (200%)"
        uitleg: "The Radar sets all text to 200%, the way a visitor with low vision would. Check whether text disappears, overlaps or falls off screen, and whether everything still works."
