...
checks:
  ...
  - titel: "Contrast-pipet"
    uitleg: "Meet zelf twee kleuren met twee pipetten, bijvoorbeeld een tekstkleur en een achtergrond. Je ziet meteen de gemeten contrastverhouding en of die voldoet aan 4,5:1 en 3:1. Handig voor kleuren die de automatische check niet kan meten, zoals tekst op een afbeelding of gradient."
    wcag: "/blog/sc-1-4-3-wat-betekent-contrast-minimum/"
