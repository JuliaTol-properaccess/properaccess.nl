  ...
  - label: "Designer"
    checks:
      ...
      - titel: "Alleen tekst vergroten (200%)"
        uitleg: "De radar zet alle tekst op 200% en laat je viewport staan, zoals de instelling “Alleen tekst zoomen” in Firefox. Kijk of er tekst wegvalt, overlapt of buiten beeld raakt en of alles nog te bedienen is."
        wcag: "/blog/sc-1-4-4-wat-betekent-tekst-vergroten/"
        onderwerp: "tekst vergroten"
      - titel: "Pagina-zoom 200% (640 px)"
