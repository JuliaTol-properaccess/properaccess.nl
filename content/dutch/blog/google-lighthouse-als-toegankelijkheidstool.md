...
Dat handmatige stuk is precies waar we de [WCAG Radar](https://testtoegankelijkheid.nl/wcag-radar) voor hebben gebouwd. Lighthouse geeft je een score en een lijst met regels. De radar markeert het punt in de pagina die je op dat moment bekijkt, zodat je zelf kijkt naar wat er staat voordat je besluit of het een bevinding is. Bij de kopvolgorde op cibg.nl was dat het hele verschil: je ziet dan dat er een onzichtbare h1 boven staat en dat de structuur klopt.
