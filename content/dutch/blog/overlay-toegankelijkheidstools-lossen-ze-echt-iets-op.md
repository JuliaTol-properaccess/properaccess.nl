...
categories: 
  - "tips-en-tools"
  - "de EAA"
description: "Werken overlay-toegankelijkheidstools echt? Mini-onderzoek naar widgets, WCAG-problemen, EAA/BDTO-naleving en gebruikerservaring."
keywords:
...
2. Voldoet een site door de implementatie aan wetgeving?
3. Is de tool zélf toegankelijk en gebruiksvriendelijk voor wie verbeteringen nodig heeft?
...
- ze herkennen maar een deel van de echte problemen, en lossen ze niet structureel op.
...
- De knop Contrast voegt een zwarte achtergrond toe maar laat onder andere paarse teksten soms ongewijzigd, waardoor ze onleesbaar worden (contrast ~1.6:1).
...
- De knop Mark Titles herkent niet alle koppen (onder andere slider) en kan nieuwe contrastproblemen veroorzaken (wit op paars met gele highlight ≈ 1.1:1).
...
### Voldoet een website aan de wet door zo’n tool toe te passen?

Nee. De tools creëren hooguit testcondities (bijvoorbeeld extra letterspatiëring) maar repareren de onderliggende problemen niet. Ze sporen veel issues niet op en regelen geen structurele WCAG‑conformiteit of wettelijke naleving (EAA/BDTO).
...
Als bewustwordingstool in je team. Laat betrokkenen even zien hoe contrast, lettergrootte of animaties gebruikers beïnvloeden. Maar: zet ze niet in als pleister op structurele problemen.
...
2. Prioriteren & fixen in de codebasis; verbeter waarneembaarheid, bedienbaarheid, begrijpelijkheid van je content en kwaliteit van techniek.
3. Scholing & governance: leidt je team op om toegankelijke content te maken en toegankelijke HTML te schrijven.
4. Her-testen met gebruikers en hulpmiddelen.
