...
Wil je zelf beginnen bij de dingen die een scanner overslaat, dan is de [WCAG Radar](https://testtoegankelijkheid.nl/wcag-radar) daarvoor gemaakt. Die zet je aan op de pagina die je bekijkt. Hij forceert een zichtbare focusrand en waarschuwt als het contrast daarvan onder 3:1 zakt, hij toont de tabvolgorde, en hij laat per element de toegankelijke naam en de rol zien. Van de bevindingen hierboven zaten de focusproblemen, de contrastrand van 1,3 op 1 en de namen die nergens op sloegen precies in die hoek.
