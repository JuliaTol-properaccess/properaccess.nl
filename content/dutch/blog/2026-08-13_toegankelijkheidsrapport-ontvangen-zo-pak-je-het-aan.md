...
Voor een snelle eigen controle tussendoor kun je de gratis [WCAG Radar van Proper Access](/tools/wcag-radar/) op je pagina zetten. Die laat direct op het scherm zien of contrast, koppen, focus en toegankelijke namen kloppen, dus je ziet meteen of je aanpassing het gewenste effect heeft voordat je een hercontrole aanvraagt. Het vervangt geen test met een schermlezer of met echte gebruikers, maar het scheelt veel heen-en-weer.
