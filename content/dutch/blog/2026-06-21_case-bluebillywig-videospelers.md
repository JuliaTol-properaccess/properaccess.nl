...
## Update 6 augustus 2026: de speler van Ping Media is opnieuw getoetst
...
Dat is een goed resultaat en het verdient een compliment aan het team van Ping Media. Volgens Stichting Accessibility ging het bij de pagina die wij onderzochten om een verouderde, klantspecifieke implementatie, die sindsdien is aangepast. Wat wij toetsten was de speler zoals die op dat moment op die pagina stond. Dat is precies wat we hieronder in les 4 schrijven: een audit is een momentopname en zegt iets over die versie, niet automatisch over de versie die er vandaag staat.

We hebben Blue Billywig gevraagd hun publicatie op dit punt aan te passen, zodat ook daar staat dat de speler van Ping Media opnieuw is getoetst.

Voor de andere leveranciers uit dit onderzoek geldt hetzelfde aanbod. Laat je speler toetsen door een onafhankelijke partij en stuur ons het resultaat, dan nemen we dat hier op.
