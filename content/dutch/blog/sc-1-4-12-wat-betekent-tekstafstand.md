...
![](https://properaccess.nl/wp-content/uploads/2025/05/1.4.12-1024x1024.png)
...
- Als een bezoeker stijlregels toepast om de afstanden aan te passen, verdwijnt er geen tekst.
...
3. Zet de Stylus-tool aan.

5. Herlaad de pagina (Ctrl + Shift + R).

7. Controleer of er geen tekst afgesneden en onleesbaar wordt.
...
- De tekst op de website reageert niet op de aanpassingen.
