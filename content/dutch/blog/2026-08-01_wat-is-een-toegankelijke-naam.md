...
Zo controleer je het zelf: zet op het tabblad **Redactie** van de [WCAG Radar](/tools/wcag-radar/) de check **Toon toegankelijke naam** aan. Bij elke link, knop en elk veld verschijnt de naam die voorleessoftware uitspreekt. Elementen zonder naam worden als fout gemarkeerd.
