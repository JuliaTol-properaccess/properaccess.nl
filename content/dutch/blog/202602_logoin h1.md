...
Neem een krant als voorbeeld. De naam van de krant staat bovenaan (je logo). Maar het artikel begint met een kop: "Inflatie daalt naar laagste peil in 3 jaar". Dat is je `<h1>`. Niet "De Krant" boven elke pagina.
...
Dus niet op elke pagina: `<h1> "Bedrijfsnaam" </>`
