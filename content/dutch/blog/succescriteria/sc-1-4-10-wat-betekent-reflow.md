...
- Controleer je ontwerp met de check Tekst vergroten 400% van onze gratis [Toegankelijkheids-lens voor designers](/tools/toegankelijkheids-lens-designers/). Je ziet direct of de tekst netjes meebeweegt of dat er iets afsnijdt of overlapt.
...
- Test tijdens het bouwen op 320 pixels in de responsive mode van je browser, of draai de check Tekst vergroten 400% van de [Toegankelijkheids-lens voor designers](/tools/toegankelijkheids-lens-designers/) op localhost. De lens werkt op elke pagina, ook achter een login.
...
Onze gratis [Toegankelijkheids-lens voor designers](/tools/toegankelijkheids-lens-designers/) heeft hiervoor de check Tekst vergroten 400%. Je sleept de lens één keer naar je bladwijzerbalk en klikt hem daarna op elke pagina aan. Alles draait in je eigen browser, er wordt niets verstuurd of opgeslagen.
...
- Test op 320 pixels in de responsive mode, of met de check Tekst vergroten 400% van de [Toegankelijkheids-lens voor designers](/tools/toegankelijkheids-lens-designers/).
