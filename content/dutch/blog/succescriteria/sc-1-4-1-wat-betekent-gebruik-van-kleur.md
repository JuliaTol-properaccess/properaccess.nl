...
- Controleer je ontwerp met de grijswaarden-check van onze gratis [Toegankelijkheids-lens voor designers](/tools/toegankelijkheids-lens-designers/). Eén klik en de hele pagina wordt grijs. Alles wat dan onduidelijk wordt, leunt te veel op kleur.
...
- Bekijk je pagina in grijstinten met de [Toegankelijkheids-lens voor designers](/tools/toegankelijkheids-lens-designers/). Begrijp je nog alles? Zie je welke tekst een link is?
...
- Draai de grijswaarden-check van de [Toegankelijkheids-lens voor designers](/tools/toegankelijkheids-lens-designers/) op localhost voordat je oplevert. De lens werkt op elke pagina, ook achter een login.

## Zo test je het

De snelste test is de grijswaarden-check in onze gratis [Toegankelijkheids-lens voor designers](/tools/toegankelijkheids-lens-designers/). Je sleept de lens één keer naar je bladwijzerbalk en klikt hem daarna op elke pagina aan. Met één klik wordt de hele pagina grijs. Stel jezelf dan deze vragen:
...
- Test met de grijswaarden-check van de [Toegankelijkheids-lens voor designers](/tools/toegankelijkheids-lens-designers/): één klik en je ziet wat er zonder kleur overblijft.
