...
- **Alleen een placeholder als label.** De meest voorkomende fout, en een afkeur onder dit criterium. Een formulier met alleen placeholders oogt strak, maar de tekst verdwijnt zodra iemand typt en het contrast is vaak te laag. Technisch krijgt het veld er wel een naam van, want een placeholder is de laatste stap in de berekening van de toegankelijke naam. Voor 3.3.2 telt dat niet: het criterium vraagt om een aanwijzing die zichtbaar blijft.
...
Een placeholder verdwijnt zodra iemand begint te typen. Wie halverwege het formulier terugkijkt, ziet niet meer wat er in de eerdere velden moest. Daarnaast is het contrast van placeholdertekst vaak te laag.

Let op het verschil met de techniek. Een schermlezer leest de placeholder wel voor als naam van het veld, want dat is de laatste stap in de berekening van de toegankelijke naam. Onder [4.1.2 Naam, rol, waarde](/blog/sc-4-1-2-wat-betekent-naam-rol-waarde/) heeft het veld dus gewoon een naam. Onder 3.3.2 is het alsnog een afkeur, omdat de aanwijzing verdwijnt op het moment dat je hem nodig hebt. Gebruik een placeholder hooguit als extra voorbeeld naast een zichtbaar label.
