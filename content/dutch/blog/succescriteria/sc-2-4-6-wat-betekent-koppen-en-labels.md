...
1. Gebruik een schermlezer of browser-extensie (zoals HeadingsMap, of het tabblad Redactie van de [WCAG Radar van Proper Access](/tools/wcag-radar/)) om een lijst van alle koppen op de pagina te genereren
