...
- Controleer je ontwerp met de check Alleen tekst vergroten van onze gratis [WCAG Radar](/tools/wcag-radar/). Eén klik en alle tekst staat op 200% terwijl je lay-out blijft staan, dus je ziet direct welke kaders niet meegroeien.
