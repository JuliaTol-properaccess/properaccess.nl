...
- Controleer je ontwerp met de doelgrootte-check van onze gratis [WCAG Radar](https://testtoegankelijkheid.nl/wcag-radar). Eén klik en elk klikbaar element dat kleiner is dan 24 bij 24 pixels licht op.
...
De snelste test is de doelgrootte-check in onze gratis [WCAG Radar](https://testtoegankelijkheid.nl/wcag-radar). Je sleept de knop één keer naar je bladwijzerbalk en klikt hem daarna op elke pagina aan, ook op localhost of achter een login. De check markeert elk klikbaar element dat kleiner is dan 24 bij 24 pixels. Loop de markeringen na met deze vragen:
...
- Test met de doelgrootte-check van de [WCAG Radar](https://testtoegankelijkheid.nl/wcag-radar): één klik en elk te klein doel licht op.
