...
banner:
  badge: "Geldt sinds 28 juni 2025"
  title: "European Accessibility Act (EAA): wat het is en wat je moet doen"
  content: "De wet die bedrijven verplicht hun digitale producten en diensten toegankelijk te maken. Op deze pagina staat wat de EAA is, voor wie hij geldt, welke norm eronder ligt, wie er toezicht houdt en welke stappen je nu zet."
  button:
    enable: true
...
faqs:
  - question: "Wat is de European Accessibility Act in het kort?"
    answer: "De EAA is richtlijn (EU) 2019/882, vastgesteld op 17 april 2019. De richtlijn verplicht bedrijven die producten en diensten aan consumenten leveren om die toegankelijk te maken voor mensen met een beperking. Nederland heeft de richtlijn omgezet met de Implementatiewet toegankelijkheidsvoorschriften producten en diensten, Staatsblad 2024, 87. De regels worden toegepast sinds 28 juni 2025."
  - question: "Geldt de EAA voor mijn bedrijf?"
    answer: "De EAA geldt voor commerciële bedrijven die digitale producten of diensten aan consumenten aanbieden. Denk aan webshops, online marktplaatsen, bankieren, verzekeren, reizen boeken, ticketverkoop, e-books, streaming en telecomdiensten. Welke wet voor je geldt hangt af van wat je organisatie is, niet van wat je verkoopt: een overheidsinstantie of publiekrechtelijke instelling valt onder het BDTO en niet onder de EAA."
  - question: "Is er een uitzondering voor kleine bedrijven?"
    answer: "Ja, voor micro-ondernemingen. De ACM omschrijft die als een onderneming met minder dan 10 mensen in dienst én een jaaromzet van maximaal 2 miljoen euro. Het moet allebei gelden, en een balanstotaal telt niet mee als criterium. Zit je daarboven, dan geldt de plicht gewoon."
  - question: "Aan welke norm moet ik voldoen?"
    answer: "Aan EN 301 549, de Europese norm voor toegankelijkheid van ICT. Die norm staat op dit moment op WCAG 2.1 niveau A en AA, samen 50 succescriteria. De versie die juridisch telt is V3.2.1 uit maart 2021, aangewezen met uitvoeringsbesluit (EU) 2021/1339. Er is een concept voor een versie 4 die WCAG 2.2 overneemt, maar dat is nog geen aangewezen norm. Proper Access toetst aan WCAG 2.2, een versie hoger dan de norm vraagt."
  - question: "Wie houdt er in Nederland toezicht op?"
    answer: "Niet één partij. Het toezicht is verdeeld over zes toezichthouders, elk voor een eigen soort product of dienst. De **ACM** voor e-handelsdiensten, dus webshops en apps, plus elektronische communicatiediensten. De **AFM** voor bankdiensten aan consumenten en e-handelsdiensten van financiële aard. De **RDI** voor apparaten, zoals computers, smartphones, geldautomaten, betaalterminals en ticketautomaten. Het **Commissariaat voor de Media** voor e-boeken en diensten die toegang geven tot audiovisuele media. De **ILT** voor personenvervoer per vliegtuig, bus, trein en over water. En de **Inspectie JenV** voor het noodnummer 112. Heb je een webshop, dan is de ACM je toezichthouder."
  - question: "Ben ik verplicht een audit te laten doen?"
    answer: "Nee. De EAA verplicht een toegankelijke website of app. Een onderzoek is geen wettelijke eis onder de EAA; het is de manier om te weten waar je staat en om het te kunnen onderbouwen als een toezichthouder ernaar vraagt. Dat is een verschil met het BDTO, waar een toegankelijkheidsverklaring met onderzoek eronder wél verplicht is voor overheidsorganisaties."
  - question: "Wat gebeurt er als ik niet voldoe?"
    answer: "De toezichthouder kan waarschuwen, een last onder dwangsom opleggen en een bestuurlijke boete geven. De ACM begon in 2026 met begeleiden: tien bedrijven kregen een volledig onderzoek volgens WCAG-EM met een rapport en daarna een bedrijfsbezoek, en bij ruim honderd bedrijven werd naar één belangrijk functioneel onderdeel van de website gekeken. Wie niet voldoet krijgt drie maanden, daarna volgt een hertest."
